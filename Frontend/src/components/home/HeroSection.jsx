...
//                 className="border-2 border-teal-600 text-teal-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-teal-50 dark:hover:bg-teal-900/20 transition-colors"
//               >
//                 Learn More
//               </button>
//             </div>
...
//             <div className="relative z-10">
//               <img
//                 src="https://blog.realcall.ai/wp-content/uploads/2022/08/Hiya-iPhone_2.png"
//                 alt="People using technology to stay safe from spam"
//                 className="rounded-2xl shadow-2xl"
//               />
//             </div>
